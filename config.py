...
class Config:
    ...
    # Real-Time Sign Recognition Parameters
    ...
    RECOGNITION_CONFIDENCE_THRESHOLD = 0.70  # 70% confidence cutoff
    RECOGNITION_SMOOTHING_BUFFER_SIZE = 6
    RECOGNITION_THROTTLE_INTERVAL = 0.08     # ~12 FPS max inference rate for CPU optimization