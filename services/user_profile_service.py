...
class UserProfileService:
    ...
    _MODULES = {"overview", "drawing", "alphabet", "recognition", "studio", "sentence", "translation", "mouse"}
    ...
    def normalize_user_id(cls, user_id: Optional[str]) -> str:
        ...
        return value or Config.DEFAULT_PROFILE_ID
    ...
    def update_profile(self, user_id: Optional[str], changes: Dict[str, Any]) -> UserProfile:
        ...
        with self._lock:
            ...
            if "adaptive_enabled" in changes:
                ...
                elif profile.interaction_mode == "legacy":
    ...
    def register_interaction(self, user_id: str, unknown: bool, confirmed: bool) -> UserProfile:
        ...
        with self._lock:
            ...
            self.repository.touch_and_increment(user_id, unknown=unknown, confirmed=confirmed)
            return profile
